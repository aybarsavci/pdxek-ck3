	...
	MainCode PixelShader
	{
		...
		[[
			...
			{	
				...
				//EK2
				float4 vPortraitAlphaTest = PdxTex2DLod( Portrait, float2(0.0f,0.0f), Input.Lod );
				if (vPortraitAlphaTest.r == 0.0f && vPortraitAlphaTest.g == 0.0f && vPortraitAlphaTest.b == 0.0f)
					vPortrait.a = max(vPortrait.a, saturate(vPortrait.r + vPortrait.g + vPortrait.b));
