Includes = {
	...
	"parallax.fxh"
	#EK EDIT: Glass shader functions
...
Effect portrait_attachment
{
	...
	BlendState = "alpha_to_coverage"
	Defines = { "USE_CHARACTER_DATA" "ATTACHEMENT_DECAY" "PDX_MESH_BLENDSHAPES"}
...
Effect portrait_attachment_pattern
{
	...
	PixelShader = "PS_attachment"
	BlendState = "alpha_to_coverage"
	Defines = { "VARIATIONS_ENABLED" "USE_CHARACTER_DATA" "ATTACHEMENT_DECAY" "PDX_MESH_BLENDSHAPES"}
}
...
Effect portrait_attachment_pattern_alpha_to_coverage
{
	...
	PixelShader = "PS_attachment"
	BlendState = "alpha_to_coverage"
	Defines = { "VARIATIONS_ENABLED" "USE_CHARACTER_DATA" "PDX_MESH_BLENDSHAPES" "ATTACHEMENT_DECAY"}
}
...
Effect portrait_attachment_alpha_to_coverage
{
	...
	PixelShader = "PS_attachment"
	BlendState = "alpha_to_coverage"
	Defines = { "USE_CHARACTER_DATA" "PDX_MESH_BLENDSHAPES" "ATTACHEMENT_DECAY"}
}
...
Effect portrait_attachment_glass
{
	...
	BlendState = "hair_alpha_blend"
	#DepthStencilState = "hair_alpha_blend"
	Defines = { "USE_CHARACTER_DATA" "EMISSIVE_NORMAL_BLUE" "ATTACHEMENT_DECAY" "PDX_MESH_BLENDSHAPES" "GLASS"}
}
...
Effect portrait_attachment_pattern_glass
{
	...
	BlendState = "hair_alpha_blend"
	#DepthStencilState = "hair_alpha_blend"
	Defines = { "VARIATIONS_ENABLED" "USE_CHARACTER_DATA" "EMISSIVE_NORMAL_BLUE" "ATTACHEMENT_DECAY" "PDX_MESH_BLENDSHAPES" "GLASS"}
}
...
Effect portrait_attachment_emissive
{
	...
	PixelShader = "PS_attachment"
	BlendState = "alpha_to_coverage"
	Defines = { "USE_CHARACTER_DATA" "ATTACHEMENT_DECAY" "PDX_MESH_BLENDSHAPES" "EMISSIVE_NORMAL_BLUE"}

}

Effect portrait_attachment_emissive_selection
{
	VertexShader = "VS_standard"
	PixelShader = "PS_court_selection"
